...
const ShoppingCart = ({isOpen, handleCart}) => {
    ...
    <div className="relative pt-16 lg:pt-8 text-gray-300 p-8 h-full">
     ...
     <RiCloseLine 
      ...
      <div className="flex items-center gap-4 flex-wrap mb-8">
        ...
        <button onClick={handleCart} className="text-[#ec7c6a] py-2 px-4 rounded-xl border border-gray-500">
          To Go
        </button>
      ...
      <div>
        ...
        {/* Products */}
        <div className="h-[400px] md:h-[700px] lg:h-[540px] overflow-scroll overflow-x-hidden">
          {/* Product */}
